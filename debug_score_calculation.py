...
def debug_score_calculation():
    ...
    # 2. 创建测试动作
    actions = [
        Action(agent='EDU', size='S', footprint_slots=['s1'], zone='mid', LP_norm=0.5, adjacency={}, cost=0, reward=0, prestige=0),
        Action(agent='EDU', size='M', footprint_slots=['s2'], zone='mid', LP_norm=0.5, adjacency={}, cost=0, reward=0, prestige=0),
        Action(agent='IND', size='L', footprint_slots=['s3'], zone='mid', LP_norm=0.5, adjacency={}, cost=0, reward=0, prestige=0),
    ]
