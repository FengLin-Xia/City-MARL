...
class SimpleBoundaryProcessor:
    ...
    def visualize_result(self, save_path: Optional[str] = None):
        ...
        fig.suptitle('简单边界地形处理结果', fontsize=16)
        ...
        if self.vertices is not None:
            ...
            if self.boundary_points:
                ...
                axes[0, 0].plot(boundary_x, boundary_y, 'r-', linewidth=2, label='简单边界')
...
def main():
    ...
    output_file = os.path.join(output_dir, "terrain_simple_boundary.json")
    ...
    processor.visualize_result(
        save_path="visualization_output/simple_boundary_terrain.png"
    )
