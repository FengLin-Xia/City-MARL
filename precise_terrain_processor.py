...
class PreciseTerrainProcessor:
    ...
    def visualize_result(self, save_path: Optional[str] = None):
        ...
        fig.suptitle('精确地形处理结果', fontsize=16)
...
def main():
    ...
    # 创建处理器
    processor = PreciseTerrainProcessor()
    ...
    output_file = os.path.join(output_dir, "terrain_precise.json")
    ...
    processor.visualize_result(
        save_path="visualization_output/precise_terrain.png"
    )
